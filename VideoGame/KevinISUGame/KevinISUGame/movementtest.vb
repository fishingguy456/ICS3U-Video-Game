...
Public Class movementtest
	...
	Private Sub tmrup_Tick(sender As Object, e As EventArgs) Handles tmrup.Tick
		...
		If Me.picplayer.Top > 0 Then 'set bounds so that the sprite cannot exit the form
			Me.picplayer.Top -= 5
		End If
	End Sub
	...
	Private Sub tmrright_Tick(sender As Object, e As EventArgs) Handles tmrright.Tick
		...
		If Me.picplayer.Left < Me.Width - Me.picplayer.Width Then
			Me.picplayer.Left += 5
		End If
	End Sub
	...
	Private Sub movementtest_Load(sender As Object, e As EventArgs) Handles MyBase.Load
	...
	Private Sub WowGreatToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles WowGreatToolStripMenuItem.Click
		home.Show()
